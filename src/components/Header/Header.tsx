import ApexLogo from "../../assets/ApexLogo_.png";
import { ModeToggle } from "../Toggles/ThemeToggler";
          ...
          <div className="grid grid-cols-4 mx-auto max-w-screen-xl">
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 items-center">
                ...
                <li className="decoration-gray-500 underline">
                  <a
                    href="#"
                    className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                  >
